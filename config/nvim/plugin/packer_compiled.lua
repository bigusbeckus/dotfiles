...
_G.packer_plugins = {
  ...
  ["DAPInstall.nvim"] = {
    loaded = true,
    path = "/home/beck/.local/share/nvim/site/pack/packer/start/DAPInstall.nvim",
  ...
  ["nvim-dap-vscode-js"] = {
    loaded = true,
    path = "/home/beck/.local/share/nvim/site/pack/packer/start/nvim-dap-vscode-js",
  ...
  ["vscode-js-debug"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/beck/.local/share/nvim/site/pack/packer/opt/vscode-js-debug",
